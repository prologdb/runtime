...
public class PrologLexerTokenMaker extends AbstractTokenMaker {
    ...
    public Token getTokenList(Segment segment, int initialTokenType, int startOffset) {
        ...
        List<com.github.prologdb.parser.lexer.Token> prologTokens = new ArrayList<>();
        ...
        com.github.prologdb.parser.lexer.Token previous = null;
        resetTokenList();

        for (com.github.prologdb.parser.lexer.Token prologToken : prologTokens) {
            if (previous == null) {
